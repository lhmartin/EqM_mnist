...
from eqm_mnist.train.utils import model_size_b, MiB
from tqdm import tqdm
import torch.nn as nn
from eqm_mnist.data.sampleable import GaussianConditionalProbabilityPath, GaussianEqM
from eqm_mnist.data.simulator import ConditionalVectorField
...
class Trainer(ABC):
    ...
    def train(self, num_epochs: int, device: torch.device, lr: float = 1e-3, **kwargs) -> torch.Tensor:
        ...
        for idx, epoch in pbar:
            ...
            scaled_loss = loss / self.data_sampler.grad_multiplier
            loss.backward()
            opt.step()
